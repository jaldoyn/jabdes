...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'Jabdes Installation Wizard'
BUILDERNAME = 'Jabdes Installation Wizard'
EXCLUDES = [ADDON_ID, 'repository.jaddesbuilds']
# Text File with build info in it.
BUILDFILE = 'https://jaldoyn.github.io/jabdes/repo/zips/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Jabdes Installation[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Jabdes Installation Wizard.\n\nContact us at https://jaldoyn.github.io/jabdes/'
...
NOTIFICATION = 'https://jaldoyn.github.io/jabdes/repo/zips/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]ENTER WIZARD NAME[/B][/COLOR]Wizard'
