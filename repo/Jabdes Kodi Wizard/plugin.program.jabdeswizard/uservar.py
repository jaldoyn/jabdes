...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Jabdes[/B][/COLOR]Wizard'
BUILDERNAME = 'JabdesWizard'
EXCLUDES = [ADDON_ID, 'repository.jabdes']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.Jabdeswizard/wiki/Installing-Builds
BUILDFILE = 'https://jaldoyn.github.io/jabdes/repo/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Jabdes[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing JabdesWizard.\n\nContact us on Github at https://jaldoyn.github.io/jabdes/'
...
REPOID = 'repository.jabdes'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/jaldoyn/jabdes/main/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/jaldoyn/jabdes/main/repo/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Jabdes[/B][/COLOR]Wizard'
